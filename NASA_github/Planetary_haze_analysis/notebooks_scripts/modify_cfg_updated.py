...
jupiter_base_cfg= open(folder+"psg_cfg_jupiter_compatible.txt", "r");
...
#change_cloud_height_getfile(absorber='Ammonia', scale_abun=500, min_level=10, max_level=40)
...
def change_cloud_height_psgspectrum(absorber, scale_abun, min_level, max_level):   #min_level, max_value, inc_abun (the amount we are increasing the abundance by)
    ...
    psg_default_data_jupiter= np.genfromtxt('/Users/apayne3/Desktop/Project_Part2_Colors/vary_params/psg_rad_jupiter_default_compatible.txt')
...
#change_cloud_height_psgspectrum(absorber='H20', scale_abun=10, min_level=0, max_level=13)